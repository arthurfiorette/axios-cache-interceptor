import{_ as s,o as n,c as a,S as p}from"./chunks/framework.cab334f2.js";const F=JSON.parse('{"title":"Debugging","description":"","frontmatter":{},"headers":[],"relativePath":"guide/debugging.md","filePath":"guide/debugging.md","lastUpdated":1695910821000}'),l={name:"guide/debugging.md"},o=p(`<h1 id="debugging" tabindex="-1">Debugging <a class="header-anchor" href="#debugging" aria-label="Permalink to &quot;Debugging&quot;">​</a></h1><p>I’m certainly sure that along the way you will find some cache behavior that is not the expected to the current situation. To help with that, the library has a separate robust build with support to debug logs enabled.</p><p>You can use it by changing the <code>setupCache</code> import:</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-fK0hR" id="tab-ePXcd3W" checked="checked"><label for="tab-ePXcd3W">EcmaScript</label><input type="radio" name="group-fK0hR" id="tab-4tx4ejZ"><label for="tab-4tx4ejZ">Common JS</label><input type="radio" name="group-fK0hR" id="tab-1_c46bQ"><label for="tab-1_c46bQ">Browser</label><input type="radio" name="group-fK0hR" id="tab-1CIvCX-"><label for="tab-1CIvCX-">Skypack</label></div><div class="blocks"><div class="language-ts vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark has-diff vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> Axios </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;axios&#39;</span><span style="color:#E1E4E8;">;</span></span>
