...
## [v1.12.3](https://github.com/arthurfiorette/axios-cache-interceptor/compare/v1.12.2...v1.12.3)

### Merged

- build(deps): bump actions/setup-node from 6 to 7 [`#1238`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1238)
- build(deps): bump pnpm/action-setup from 5 to 6 [`#1230`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1230)
- build(deps): bump github/codeql-action from 4 to 4.37.3 [`#1242`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1242)

### Commits

- Prevent response reuse for concurrent Vary: * requests [`87603a0`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/87603a07a5d6dfb89a49297c63f73ddc16ac2cff)

## [v1.12.2](https://github.com/arthurfiorette/axios-cache-interceptor/compare/v1.12.1...v1.12.2) - 2026-08-03

### Merged

- build(deps-dev): bump axios from 1.15.0 to 1.18.0 [`#1239`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1239)

### Commits

- Run `pnpm update --latest` [`8a3dfe0`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/8a3dfe01e576c320c91f25885b292c0a51f9df25)
- Update axios to 1.19.0 and other dependencies [`e3b5ef7`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/e3b5ef78e11d8f01afd7b5d68f6b68ec86778c16)
- Update changelog [`819fb77`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/819fb775333b3d5c45ce28ba54c58af0fd09983b)

## [v1.12.1](https://github.com/arthurfiorette/axios-cache-interceptor/compare/v1.12.0...v1.12.1) - 2026-07-22

### Merged

- fix: settle followers after shared storage updates [`#1241`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1241)
- build(deps): bump codecov/codecov-action from 5 to 7 [`#1235`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1235)
- build(deps): bump actions/checkout from 6 to 7 [`#1237`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1237)
- build(deps-dev): bump axios from 1.13.6 to 1.15.0 [`#1229`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1229)
- build(deps-dev): bump tsdown from 0.20.3 to 0.21.7 [`#1225`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1225)
- build(deps): bump follow-redirects from 1.15.11 to 1.16.0 [`#1232`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1232)
- build(deps): bump handlebars from 4.7.8 to 4.7.9 [`#1224`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1224)
- build(deps): bump pnpm/action-setup from 4 to 5 [`#1216`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1216)
- Add frontmatter to skill file and fix skill install command [`#1213`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1213)
- docs: add .agents/skills/axios-cache-interceptor.md and AI install guide [`#1212`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1212)
- docs: improve writing quality across all documentation pages [`#1210`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1210)
- docs: move cache.ttl first-cached note out of warning block to bottom of section [`#1211`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1211)
- docs: clarify that `cache.ttl` is set once and document workaround for per-request TTL changes [`#1209`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1209)
- build(deps-dev): bump @types/node from 24.11.0 to 24.12.0 [`#1202`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1202)

### Commits

- Remove useless benchmark and comparison page [`795d51f`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/795d51fa7d7ec31bea16d06e922c9a35cf5c66fd)

## [v1.12.0](https://github.com/arthurfiorette/axios-cache-interceptor/compare/v1.11.4...v1.12.0) - 2026-03-04

### Merged

- feat: add optional manual interceptor registration [`#1199`](https://github.com/arthurfiorette/axios-cache-interceptor/pull/1199)
...
- Fix test:types script [`23e0d68`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/23e0d6810c49fbd4245513b55cab031dbc639a6d)
- tag: v1.11.0 [`3a1f2d8`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/3a1f2d85e8866785108b4103901a2104471405b1)
- Update changelog [`913aff5`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/913aff52d80e1914dbbabaafbaba5496c0ea10ae)
...
- tag: v1.9.2 [`cf89a7b`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/cf89a7b5ec6667c0fff0fb8e3a84de8fa5829e32)
...
- chore: update dependecies [`7204578`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/7204578f0074cd9bcb628cf4941174cfa44e024b)
...
- Updated dependencies [`fa82cd8`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/fa82cd80122fa14c39b2da02795c2add202d3e7e)
...
- fix environment url [`cb80754`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/cb807545140f595359d23cf1aa0ece57b51e56a2)
- tag: v1.9.0 [`f9296d0`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/f9296d08789087d9ea79e26344c8f7ea9dbc528e)
...
- refactor: remove Object.freeze [`55da840`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/55da840f7bb264f8d45c39182a4f4dca7984e6a1)
- tag: v1.8.3 [`10c467d`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/10c467dbd25d625c43de41861a1782ad775c00be)
...
- chore: remove console.log [`186d294`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/186d294b6d00be847092a9b212ead0d01568e45f)
- style: fix linting issues [`9a553a3`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/9a553a39a76afcfe0c7d358fe580b272e7bc2080)
...
- Delete docs/src/public/llms.txt [`5027a31`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/5027a3169a5b688e7c319f797632bb2f90664f96)
- docs: add ask chatgpt button [`53daca7`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/53daca798354aae1e951c50fde0463aed291642b)
- docs: documentation redesign [`c765578`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/c765578edb7a9bafec9a35647cfc039d42ec51a0)
- docs: fix prompt [`7568ab6`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/7568ab62543efc4129181d182f0b840116bdfc47)
- docs: homepage styling [`40517bf`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/40517bf35afc624f4a8db90406c92f77b2f649ef)
- docs: readme chatgpt link [`8d9ecf0`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/8d9ecf0ccddd4d12434db6fc9957b7d4f9393ddc)
- feat: update biome config [`cc8c8b0`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/cc8c8b0b0498d5656bdba2b61d96e09e7cc5d0e0)
- style: format jsdoc and markdown content [`5fc6f49`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/5fc6f499ddab1a83d0b84ab11d34922244f3b00d)
- style: lint [`09f8ce2`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/09f8ce2062fd7eba7ad5be5be8daaafd72f77f66)
- style: lint code [`01b8e65`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/01b8e657e8ad65047976c68c5f9362e7a7415d08)
...
- Update request-specifics.md [`9e3b4fc`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/9e3b4fcd6616e9f6241bee1a4c111e36f4263e81)
...
- docs: basic llms.txt [`d79a254`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/d79a25498f57074285ef4061feacea0b0681626a)
- docs: changelog [`66848fb`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/66848fb5d57bc3248a2e34627ceb8c80092b3766)
...
- Update config.mts [`6d57808`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/6d578087c6a0d9719661648e9687ef8fecbaf1e2)
...
- docs: update changelog [`2608bc0`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/2608bc094774a37014e73c3c6e275e94ef000fcc)
- feat: `location` and `Cache-Control: private` [`1178d33`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/1178d334dc82d3c8ff2610c4dbcaf7738e1c4893)
- fix: check types on CI run [`cf3a377`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/cf3a3774d288d2b39c1202553795ce68a145c294)
- fix: fix pkg json [`c6b4911`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/c6b4911b0a97f9f872ca360c712aa0e51f83aed1)
...
- fix: typing issues with axios &gt;= 11.7.8 (#953) [`ff5589f`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/ff5589f9fb244b4d28be60a4cc2abf2db38586f3)
- style: format code [`38c393f`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/38c393fc77e05acac9e7fb1b6b8ca209e765095a)
- tag: v1.7.0 [`ec06bd7`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/ec06bd78450ec8aa37e01855734e2fe3386f089d)
...
- chore: revert analytics [`4a8c889`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/4a8c8895cfa1dbe562e5e6736dcf7e968b94dc67)
- docs: fix deploy [`d4d1d2b`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/d4d1d2bbec3f904995d677beb2c28e6d73d34c8e)
- docs: self hosted plausible [`869d174`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/869d174aa875544e022401c0e536d77a9ce4f6da)
- style: formatted code [`2946b5b`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/2946b5b50265d2b4df506c291cfbd7931a0b9329)
- style: lint [`bf6843d`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/bf6843d0f90737af489263e30236fdeab3c07a35)
- tag: v1.6.2 [`4626ec0`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/4626ec0818f42d66ad229d35b3572e62efbdaf6d)
- Update docs.yml [`545dd46`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/545dd46c82ccee7c49c33d090a5e819c007bed48)
- Update README.md [`1dc9415`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/1dc9415aa70930152e6c4109138bfc7f35e1dba8)
...
- fix: type incompatibility [`f96b55d`](https://github.com/arthurfiorette/axios-cache-interceptor/commit/f96b55dc54c44cfa40634e2da0b41fdd9caf2dae)
